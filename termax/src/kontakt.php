...
<div class="container">
    <div id="kontakt" style="border-bottom: 1px solid red; clear:both;  padding-bottom: 5rem;">
        <br>
        <br>
        <br>
        <div>
...
<div class="contactwrap2 mb-5">
    <div class="container contact mb-5  upit">
        <div class="row">
            <div class="col-xl-6 col-lg-5 col-md-5 info">
            ...
            <div class="col-xl-1 col-lg-2 col-md-2 social">
